...
# Exibir Resultados
cv2.imshow('Resultado 01 HarrisCornerDetector:', image01)
cv2.imshow('Resoltado 02 HarrisCornerDetector:', image02)
cv2.imshow('Resultado 03 HarrisCornerDetector:', image03)
cv2.waitKey(0)
